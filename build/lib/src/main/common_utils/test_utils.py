...
import src.main.tests_constants.test_conditions_oper as common_constants
from src.main.tests_constants.test_conditions_oper import TEST_SET
...
def get_test_description(input_test_number):
    ...
    return TEST_SET.get(input_test_number, common_constants.TEST_NUMBER_ERROR)
