...
DATALINK = {
    ...
    'Gaia DR3_INT3': "select top 10 source_id from @FULL_QUALIFIED_PATTERN@ where has_xp_mean_spectrum = 'true' AND "
    ...
    'Gaia DR3_INT4': "select top 10 source_id from @FULL_QUALIFIED_PATTERN@ where has_xp_continuous = 'true' AND "
                     "has_xp_sampled = 'true' AND has_rvs = 'true' AND has_mcmc_gspphot = 'true' AND has_mcmc_msc "
                     "= 'true' order by source_id asc limit 10",
    'Gaia DR3_INT4_IDS': ['Gaia DR3_INT4 2851858288640',
                          'Gaia DR3_INT4 7632157690368',
                          'Gaia DR3_INT4 9281425163264',
                          'Gaia DR3_INT4 12545600306304',
                          'Gaia DR3_INT4 13301514552192',
                          'Gaia DR3_INT4 13473313244288',
                          'Gaia DR3_INT4 15741055975040',
                          'Gaia DR3_INT4 16531329957376',
                          'Gaia DR3_INT4 15530601898496',
                          'Gaia DR3_INT4 15741055975040',
                          'Gaia DR3_INT4 16531329957376',
                          'Gaia DR3_INT4 16870631694208'],
    'Gaia DR3_INT3_IDS': ['Gaia DR3 6917528138584192384',
                          'Gaia DR3 6917527893770189696',
                          'Gaia DR3 6917527721971537664',
                          'Gaia DR3 6917527073433171072',
                          'Gaia DR3 6917528649684202496',
                          'Gaia DR3 6917528443525529728',
                          'Gaia DR3 6917527794986540928',
                          'Gaia DR3 6917527721971537664',
                          'Gaia DR3 6917376676561575296',
                          'Gaia DR3 6917376543418816512',
                          'Gaia DR3 6917376470403120384',
                          'Gaia DR3 6917376298604424064',
                          'Gaia DR3 6917350322641840128',
                          'Gaia DR3 6917347058466697088',
                          'Gaia DR3 6917337819992561920',
                          'Gaia DR3 6917335547954943360',
                          'Gaia DR3 6917523843616561536',
                          'Gaia DR3 6917516662431161472',
                          'Gaia DR3 6917507896403705728',
                          'Gaia DR3 6917496901287269888',
                          'Gaia DR3 6917523843616561536',
                          'Gaia DR3 6917516662431161472',
                          'Gaia DR3 6917507896403705728',
                          'Gaia DR3 6917495806069905280',
                          'Gaia DR3 6917490922691367168'],
    'request_sent': '<table><tr><td><b>STEP-1:</b></td><td> Do Login(): Gaia.login(user=USERNAME, '
                    'password=PASSWORD)</td></tr> '
...
DR3_INT3_DATALINK_EXPECTED_RESULTS = {
    'RVS': 8,
    'XP_CONTINUOUS': 12,
    'XP_SAMPLED': 12,
    'EPOCH_PHOTOMETRY': 8,
...
DR3_INT4_DATALINK_EXPECTED_RESULTS = {
    'RVS': 10,
    'XP_CONTINUOUS': 10,
    'XP_SAMPLED': 10,
    'EPOCH_PHOTOMETRY': 2,
...
DATALINK_RETRIEVAL_TYPES = {
    'Gaia DR3_INT4': DR3_INT4_DATALINK_EXPECTED_RESULTS,
    'Gaia DR3_INT3': DR3_INT3_DATALINK_EXPECTED_RESULTS
}

DR3_INT3_DATALINK_COMPARE_EXPECTED_RESULTS = {
    'RVS': 10,
    'XP_CONTINUOUS': 10,
    'XP_SAMPLED': 10,
    'EPOCH_PHOTOMETRY': 10,
...
DR3_INT4_DATALINK_COMPARE_EXPECTED_RESULTS = {
    'RVS': 10,
    'XP_CONTINUOUS': 10,
    'XP_SAMPLED': 10,
    'EPOCH_PHOTOMETRY': 10,
...
DATALINK_COMPARE_RETRIEVAL_TYPES = {
    'Gaia DR3_INT4': DR3_INT4_DATALINK_COMPARE_EXPECTED_RESULTS,
    'Gaia DR3_INT3': DR3_INT3_DATALINK_COMPARE_EXPECTED_RESULTS
}

GAIA_RELEASES = {
    'Gaia DR3_INT3': 'user_dr3int3',
    'Gaia DR3_INT4': 'user_dr3int4'
}
...
__all__ = ['LOGIN', 'LOGOUT', 'GET_PUBLIC_TABLES', 'LOAD_TABLE', 'SYNCHRONOUS_QUERY',
           ...
           'CROSS_MATCH', 'DATALINK', 'DATALINK_COMPARE', 'DR3_INT3_DATALINK_EXPECTED_RESULTS',
           'DR3_INT4_DATALINK_EXPECTED_RESULTS', 'DATALINK_COMPARE_RETRIEVAL_TYPES',
           'DR3_INT3_DATALINK_COMPARE_EXPECTED_RESULTS', 'DR3_INT4_DATALINK_COMPARE_EXPECTED_RESULTS',
           'DATALINK_RETRIEVAL_TYPES',
           'GAIA_RELEASES']
