...
DATALINK = {
    ...
    'Gaia DR3INT3': "select top 10 source_id from @FULL_QUALIFIED_PATTERN@ where has_xp_mean_spectrum = 'true' AND "
    ...
    'Gaia DR3': "select top 10 source_id from @FULL_QUALIFIED_PATTERN@ where has_xp_continuous = 'true' AND "
                "has_xp_sampled = 'true' AND has_rvs = 'true' AND has_mcmc_gspphot = 'true' AND has_mcmc_msc = 'true' "
                "order by source_id asc",
    'Gaia DR3INT3_IDS': ['Gaia DR3INT3 4403357942541290240',
                         'Gaia DR3INT3 4403382376614696064',
                         'Gaia DR3INT3 4403383338687050752',
                         'Gaia DR3INT3 4404001710895683200',
                         'Gaia DR3INT3 4404101079261158144',
                         'Gaia DR3INT3 4404101938254628224',
                         'Gaia DR3INT3 4404102865967569408',
                         'Gaia DR3INT3 4404102865967570560',
                         'Gaia DR3INT3 4404105442948109824',
                         'Gaia DR3INT3 4404105855264817024'],
    'Gaia DR3_IDS': ['Gaia DR3 3111611584415482240',
...
DR3INT3_DATALINK_EXPECTED_RESULTS = {
    'RVS': 10,
    'XP_CONTINUOUS': 10,
    'XP_SAMPLED': 10,
    'MCMC_MSC': 10
...
DATALINK_RETRIEVAL_TYPES = {
    'Gaia DR3INT3': DR3INT3_DATALINK_EXPECTED_RESULTS,
    'Gaia DR3': DR3_DATALINK_EXPECTED_RESULTS
}

DR3INT3_DATALINK_COMPARE_EXPECTED_RESULTS = {
    'RVS': 10,
    # 'XP_CONTINUOUS': 10,
    'XP_SAMPLED': 10,
    'MCMC_MSC': 6
...
DR3_DATALINK_COMPARE_EXPECTED_RESULTS = {
    'XP_SAMPLED': 10,
    'XP_CONTINUOUS': 10,
    'RVS': 10,
    'MCMC_GSPPHOT': 5,
...
DATALINK_COMPARE_RETRIEVAL_TYPES = {
    'Gaia DR3INT3': DR3INT3_DATALINK_COMPARE_EXPECTED_RESULTS,
    'Gaia DR3': DR3_DATALINK_COMPARE_EXPECTED_RESULTS
}

GAIA_RELEASES = {
    'Gaia DR3INT3': 'user_dr3int3',
    'Gaia DR3': 'user_dr3int4'
}
...
__all__ = ['LOGIN', 'LOGOUT', 'GET_PUBLIC_TABLES', 'LOAD_TABLE', 'SYNCHRONOUS_QUERY',
           ...
           'CROSS_MATCH', 'DATALINK', 'DATALINK_COMPARE', 'DR3INT3_DATALINK_EXPECTED_RESULTS',
           'DR3_DATALINK_EXPECTED_RESULTS', 'DATALINK_COMPARE_RETRIEVAL_TYPES',
           'DR3INT3_DATALINK_COMPARE_EXPECTED_RESULTS', 'DR3_DATALINK_COMPARE_EXPECTED_RESULTS',
           'DATALINK_RETRIEVAL_TYPES',
           'GAIA_RELEASES']
